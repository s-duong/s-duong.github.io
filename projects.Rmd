...
The **overarching goal** of this project was to find **computationally-inexpensive ways** to uncover additional conversational patterns in existing data for the purposes of (1) **enhancing scientific knowledge** on language and learning, (2) optimizing **data reuse** within the <a href=https://lrdc.pitt.edu/ppel/>Parents Promoting Early Learning Study</a>, and (3) **sharing this method** with researchers.
...
I have conducted exploratory data analysis in many courses. Below are 3 of my favorite EDA reports. I had the most fun working on them for various reasons (e.g., I got to choose a personally interesting dataset, I was learning something new and exciting). 
