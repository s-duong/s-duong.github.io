...
This project showcased a **computationally-inexpensive way** to uncover additional insights in existing transcription data for the purposes of (1) **enhancing scientific knowledge** on language and learning, (2) **optimizing data reuse** within the <a target="_blank" rel="noopener noreferrer" href="https://lrdc.pitt.edu/ppel/">Parents Promoting Early Learning Study</a>, and (3) **sharing this method** with researchers.
